...
<div class="main" style="margin-left:5% ; margin-right:5%;">
    ...
    <form action="updateAdminProcess.php" method="POST">
        <table class="table " width=98% style="margin-top:5% ;">
            ...
            <tr>
                <td>Phone Number: </td>
                <td><input type="text" class="form-control" name="telephone" value="<?php echo $r['telephone']; ?>"></td>
            </tr>

            <tr>
                <td>Email Address:</td>
                <td><input type="text" class="form-control" name="email" value="<?php echo $r['email']; ?>"></td>
            </tr>
            <tr>
                <td>Home Address:</td>
                <td><input type="text" class="form-control" maxlength="255" name="address" value="<?php echo $r['address']; ?>" style="width:100% ; height:100px;"></td>
            </tr>
        </table>
