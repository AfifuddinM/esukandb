  ...
  ?>
      ...
      <form action="book1.php" method="post">
        ...
        <div class="dependent" style="display:flex ; flex-direction:column; width:30% ;margin-left:100px;">
          ...
          dependentId:<input type="text" class="form-control" name="dependentid" required>
          dependentUsername:<input type="text" class="form-control" name="dependentusername" required>
        </div>
        <br><br><br><br><br><br>
        <hr>
